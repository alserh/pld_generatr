...
// let testSecurityArray = [
//   'AAPL', 'MSFT', 'GOOG', 'AMZN', 'NVDA', 'BRK-B', 'META',
//   'TSLA', 'LLY',  'V',    'UNH',  'JNJ',  'JPM',   'XOM',
//   'WMT',  'MA',   'PG',   'AVGO', 'HD',   'ORCL',  'CVX',
//   'MRK',  'ABBV', 'KO',   'PEP',  'COST', 'BAC',   'ADBE',
//   'CSCO', 'MCD',  'TMO',  'CRM',  'PFE',  'CMCSA', 'NFLX',
//   'DHR',  'ABT',  'AMD',  'TMUS', 'NKE',  'DIS',   'WFC',
//   'TXN',  'UPS',  'INTC', 'PM',   'CAT',  'MS',    'AMGN',
//   'VZ',   'INTU', 'BA',   'COP',  'UNP',  'NEE',   'LOW',
//   'BMY',  'IBM',  'DE',   'RTX',  'HON',  'GE',    'QCOM',
//   'SPGI', 'AXP',  'BKNG', 'AMAT', 'NOW',  'SBUX',  'PLD',
//   'LMT',  'ELV',  'SCHW', 'GS',   'SYK',  'ISRG',  'ADP',
//   'T',    'BLK',  'GILD', 'MDLZ', 'TJX',  'MMC',   'CVS',
//   'ADI',  'VRTX', 'UBER', 'REGN', 'LRCX', 'ZTS',   'AMT',
//   'CI',   'C',    'SLB',  'ABNB', 'BDX',  'MO',    'FI',
//   'EOG',  'BSX'
// ]
let testSecurityArray = [
    'IE00BYXYYJ35', 'GOOG'  ]
let currencyArray = ["USD"]
let sanyaUser = generateAccount(testSecurityArray, 0);
